<?php
	...
	if(!empty($bNo) && empty($_COOKIE['board_free_'.$bNo])){
		...
		if(empty($result)){
			...
			setcookie('board_fee_'.$bNo, TRUE, time()+(60*60^24),'/');
		}
	}
...
<body>
	<article class="boardArticle">
		...
		<div id="boardView">
			...
			<div class="btnSet">
				<a href="./freeBoard/write.php?bno=<?php echo $bno?>">수정</a>
				<a href="./freeBoard/delete.php?bno=<? echo $bNo ?>">삭제</a>
				<a href="./freeBoard/">목록</a>
			</div>
		</div>
	</article>
</body>
